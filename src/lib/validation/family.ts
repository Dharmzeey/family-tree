...
import { z } from "zod";
import { addBeliefSystemApi, addEulogyApi, addFamilyHeadApi, addHandlerApi, addHouseInfoApi, addOriginApi, addOtherInformationApi } from "../api/family";
...
export async function addFamilyHead(
    ...
    const schema = z.object({
        person: z.string().nonempty("This field cannot be empty"),
