...
import { addFamilyOrigin } from "@/lib/validation/family";
...
export default function AddFamilyOrigin() {
    const [formState, formAction] = useActionState(addFamilyOrigin, initialState)
        ...
        <>
            <div className="bg-[#ffffff0a] shadow-xl backdrop-blur-md w-9/12 lg:w-1/2 py-8 px-4 rounded-2xl">
                <form action={formAction} className="flex flex-col justify-center items-center w-full">
                    <h2 className="text-2xl">Add Family Origin</h2>
                    ...
                    />
                    <SubmitButton pendingText="Adding..." buttonText="ADD FAMILY ORIGIN" />
                    {formState.error && (
